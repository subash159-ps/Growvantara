    ...
    <>
      <section className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6">
        <SectionHeading
          eyebrow="Our work"
          title="Portfolio"
          description="Growvantra is a growing agency. Every item below is a demo website, sample campaign, or concept project — clearly labeled — that shows the kind of work we do. Real client case studies will join this page as engagements complete."
        />
      </section>
